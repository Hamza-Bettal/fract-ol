...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/08 15:04:25 by hbettal           #+#    #+#             */
/*   Updated: 2024/02/09 21:02:17 by hbettal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	name_check(int ac, char **av)
{
	...
	str = "example : ./fractol_bonus mandelbrot\n or : ./fractol_bonus julia <r> <i>\n or : ./fractol_bonus ship";
	if (ac > 1)
	{
		if (!ft_strcmp(av[1], "mandelbrot") && ac == 2)
			return (0);
		else if (!ft_strcmp(av[1], "ship") && ac == 2)
			return (0);
